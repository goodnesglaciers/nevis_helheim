...
oo.fn = 'nevis_h22222_ubspatial_R227_lakerampM_4tiles_Ks100_s1e6H_repo';  % filename
...
% set Ub to a spatially varying field based on MeAsUrEs obs
...
runoff_2007_nevis_h30km(229,25658) = 30; % revert day 229 back to normal racmo level
% make runoff on DOY 227 everyday in the run 
runoff_2007_nevis_h30km(228,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(229,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(230,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(231,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(232,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(233,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(234,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(235,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(236,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(237,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(238,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(239,:) = runoff_2007_nevis_h30km(227,:);
runoff_2007_nevis_h30km(240,:) = runoff_2007_nevis_h30km(227,:);
% change this racmo forcing to be at a 0.1 day timestep for 228 through 240
runoff_here = runoff_2007_nevis_h30km(228:240,:);
...
runoff_time = [228:0.05:240.95];

% RAMP up the lake drainage
% full drainage over 9.4 hours 229.5 to 229.9
volume = 8.8888e+05; % spread out 10^10 mm w.e. over 150m x 150m tile over 12 hrs.
drainage_rate9_flat = volume/(0.4*4*2); % over 0.4 days and 4 tiles
% over 4 tiles evenly, step up in time
...
load('nevis_h22222_ubspatial_R227_lakerampM_4tiles_Ks100_s1e6H/0281.mat','vv','tt') % load a former timestep as an initial
% run at a 0.1 day timestep
[tt,vv,info] = nevis_timesteps([228:0.025:235]*pd.td/ps.t,vv,aa,pp,gg,oo,pd,ps);
